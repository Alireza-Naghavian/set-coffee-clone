...
import { FaListUl, FaNewspaper, FaPlus, FaShoppingBag, FaUsers } from "react-icons/fa";
import { HiTicket } from "react-icons/hi2";
import { IoDocument } from "react-icons/io5";
import { IconType } from "react-icons/lib";
import { MdManageAccounts, MdSms } from "react-icons/md";
...
export const subMenuTitles = [
  {
    ...
    href: `/categories?categoryId=667fed788adb606b5273c865`,
  },
  {
    label: "World Class Specialty",
    href: `/categories?categoryId=667fed428adb606b5273c859`,
  },
  {
    label: "Premium Coffee",
    href: `/categories?categoryId=667fed2b8adb606b5273c852`,
  },
  {
    label: "Commercial Coffee",
    href: `/categories?categoryId=667fed338adb606b5273c856`,
  },
  {
    label: "Coffee Capsule",
    href: `/categories?categoryId=667fed928adb606b5273c86b`,
  },
  {
    label: "Italian Passion",
    href: `/categories?categoryId=667fed828adb606b5273c868`,
  },
];
export const optionValues = [
  {
    label: "بر اساس جدید ترین",
    value: "latest",
  },
  {
    label: "بر اساس قدیمی ترین",
    value: "earliest",
  },
  {
    label: "بر اساس ارزان ترین",
    value: "lower_price",
  },
  {
    label: "بر اساس گرانترین",
    value: "expensive",
  },
];
...
export const productSelectionOption: OptionSelectionType = [
  {
    label: "توضیحات",
    value: "desc",
  },
  { label: "مشخصات", value: "moreDetail" },
  { label: "نظرات", value: "comments", optionalItem: true },
];
export const adminCharts: OptionSelectionType = [
...
export type AdminItemType = {
  ...
  icon: IconType;
  label: string;
  section: "users" | "comments" | "tickets";
};

export const AdminSideBarItem: AdminItemType[] = [
  {
...
type AdminDropDownType = Pick<AdminItemType, "icon" | "label" | "targetLink">&{
  isMenuOpen?:boolean,
...
export const DropDownAdminItem :AdminDropDownType[]=[
  {
    icon:FaShoppingBag,
    label:"محصولات",
    subLabel:"افزودن",
    subLabel_2:"مدیریت محصولات",
    subTargetLink:"/p-admin/products",
    subTargetLink_2:"/p-admin/products/manage",
    subIcon:FaPlus,
    subIcon_2:MdManageAccounts,
    targetLink:"/p-admin/products"
  },
  {
    icon:BiSolidOffer,
    label:"تخفیفات",
    subLabel:"افزودن کد تخفیف",
    subLabel_2:"لیست کد ها",
    subTargetLink:"/p-admin/offers/create",
    subTargetLink_2:"/p-admin/offers/list",
    subIcon:FaPlus,
    subIcon_2:FaListUl,
  ...
  },
  {
    ...
    label:"مقاله ها",
    subLabel:"افزودن",
    subLabel_2:"لیست  مقالات",
    subTargetLink:"/p-admin/blogs/add",
    subTargetLink_2:"/p-admin/blogs/list",
    subIcon:FaPlus,
    subIcon_2:IoDocument,
