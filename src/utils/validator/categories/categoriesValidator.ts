...
export const productSchema = Joi.object().keys({
  category: Joi.string()
    ...
    .error(createHttpError.BadRequest("عنوان دسته بندی وارد شده معتبر نمی‌باشد")),
  ...
  longDesc: Joi.string()
    ...
    .error(createHttpError.BadRequest("توضیحات اصلی کالا معتبر نمی‌باشد (حداقل ۱۰ کاراکتر)")),
  ...
  title: Joi.string()
    ...
    .error(createHttpError.BadRequest("عنوان کالا معتبر نمی‌باشد (حداقل ۳، حداکثر ۲۰ کاراکتر)")),
  ...
  shortDesc: Joi.string()
    ...
    .error(createHttpError.BadRequest("قسمت توضیحات کوتاه معتبر نمی‌باشد (حداقل ۱۰، حداکثر ۵۰ کاراکتر)")),
  ...
  smell: Joi.string()
    ...
    .error(createHttpError.BadRequest("قسمت عطر کالا معتبر نمی‌باشد (حداقل ۳، حداکثر ۲۰ کاراکتر)")),
  ...
  suitableFor: Joi.string()
    ...
    .error(createHttpError.BadRequest("قسمت مخاطب کالا معتبر نمی‌باشد (حداقل ۳، حداکثر ۲۲۰ کاراکتر)")),
